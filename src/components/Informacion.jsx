...
const Informacion = () => {
    return (
        <div className='container-faq' id="informacion">
            ...
            <Accordion title="¿El valor de las entradas en fijo?" content="No, el valor de las entradas ira aumentando con el correr del tiempo, te recomendamos comprarla lo antes posible" />
            <Accordion title="¿Que valor tienen los palcos VIPS?" content="El valor de los palcos vips varia segun la ubicacion, puedes comunicarte con nosotros en nuestras redes sociales para obtener mas informacion" />
